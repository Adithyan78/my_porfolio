export const skillsContent = `
            <div class="skills-apps-grid">
                <div class="skill-app" data-skill="python">
                ...
                <div class="skill-app" data-skill="html">
                    <div class="skill-icon">
                        <img src="assets/icons/html5.svg" class="skill-icon-img" alt="HTML5">
                    </div>
                    <div class="skill-name">HTML5</div>
                    <div class="skill-level">Expert</div>
                </div>

                <div class="skill-app" data-skill="css">
                    <div class="skill-icon">
                ...
                <div class="skill-app" data-skill="mysql">
                    <div class="skill-icon">
                        <img src="assets/icons/mysql.svg" class="skill-icon-img" alt="MySQL">
                    </div>
                    <div class="skill-name">MySQL</div>
                    <div class="skill-level">Advanced</div>
                </div>

                <div class="skill-app" data-skill="javascript">
                    <div class="skill-icon">
